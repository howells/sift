	...
	return (
		<Box flexDirection="column" padding={1}>
			...
			{step === "google_creds" && (
				<Box flexDirection="column" marginTop={1}>
					...
					<Box marginTop={1} flexDirection="column">
						<Text>
							1. Go to{" "}
							<Text color="cyan">https://console.cloud.google.com</Text>
						</Text>
					...
					<Box marginTop={1}>
						<Text>
							Press <Text color="cyan">Enter</Text> when ready
						</Text>
					</Box>
				</Box>
			)}
			...
			{step === "more_accounts" && (
				<Box flexDirection="column" marginTop={1}>
					<Text color="green">
						✓ Added: {accounts[accounts.length - 1]?.email}
					</Text>
					<Box marginTop={1}>
