...
export function TodoList({ todos, selectedIndex, showAccount = true }: TodoListProps) {
  ...
  type ListItem = { type: "header"; title: string; icon: string; color: string; count: number } | { type: "todo"; todo: Todo; globalIndex: number };
